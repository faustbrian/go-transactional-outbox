...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-transactional-outbox" &&
                "${module_path}" != github.com/faustbrian/go-transactional-outbox/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-transactional-outbox"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
